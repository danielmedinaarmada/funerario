class Juego {
  ...
  constructor(){
    ...
    this.preguntas = [
      {
        pregunta: "La póliza de Mercantil Seguros de Tranquilidad Plus, es una póliza de:",
        img: "img/validar.png",
        respuestas: [
          {opcion: 0, texto: 'Familiar', valor: true, img: "" },
          {opcion: 1, texto: 'Colectiva',valor: false, img: "" },
          {opcion: 2, texto: 'Individual',valor: false, img: "" },
          {opcion: 3, texto: 'Corporativa',valor: false, img: "" }
        ]
      },{
        pregunta: "Los póliza de Tranquilidad Plus de Mercantil Seguro es una póliza de:",
        img: "img/validar.png",
        respuestas: [
          {opcion: 0, texto: 'Tranquidad para viajes al exterior', valor: false, img: "" },
          {opcion: 1, texto: 'Servicios Funerarios', valor: true, img: "" },
          {opcion: 2, texto: 'Tranquilidad para gastos medicos', valor: false, img: "" },
          {opcion: 3, texto: 'Cobertura HCM', valor: false, img: "" },
        ...
        pregunta: "¿Que medio de pago es valido, para el pago de la póliza de Tranquilidad Plus?",
        img: "img/validar.png",
        respuestas: [
        ...
        pregunta: "Que familiares puedo incluir en la póliza de Tranquilidad Plus de Mercantil Seguros",
        img: "img/validar.png",
        respuestas: [
        ...
        img: "img/validar.png",
        respuestas: [
          {opcion: 0, texto: 'Colesterol', valor: false, img: "" },
          {opcion: 1, texto: 'Triglicérido', valor: false, img: "" },
          {opcion: 2, texto: 'Perfil lipídico', valor: false, img: "" },
          {opcion: 3, texto: 'Perfil hepático', valor: true, img: "" },
          {opcion: 4, texto: 'Perfil triode', valor: false, img: "" },
          {opcion: 5, texto: 'Panel metabólico integral', valor: false, img: "" },
          {opcion: 6, texto: 'No requiere examen', valor: false, img: "" }
        ]
      },{
        pregunta: "En una póliza de Tranquilidad Plus el Tomador puede ser Asegurado",
        img: "img/validar.png",
        respuestas: [
